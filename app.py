...
st.markdown('###### App to analyse the balance and transactions of any ethereum address')

# Streamlit text entry box for eth address
address = st.text_input("Enter ethereum address or ENS name:", value="0x5ea9681C3Ab9B5739810F8b91aE65EC47de62119")
st.text("*Pre-filled with a demo address")
...
def get_transactions(address):
    ...
    with plt.style.context({
        ...
        # Print the code which was used to make the analysis
        st.text("How the analysis is performed:")
        st.code('''#Function to get a list of all transactions by address
def get_transactions(address):
    ...
    for transaction in transactions:
        ...
        st.markdown('##')
        st.text("How the APIs are called:")
        st.code('''#Etherscan API URL
BASE_URL = 'https://api.etherscan.io/api'
#Infura API URL
INFURA_URL = 'https://mainnet.infura.io/v3/'
load_dotenv()
...
def make_api_url(module, action, address, **kwargs):
    ...
    return url''')
        ...
        # How the graph is styled
        st.markdown('##')
        st.text("How the graph is styled:")
        st.code('''# Set the style of the chart using the custom style
with plt.style.context({
    'figure.facecolor': '#0E1117',
    'axes.facecolor': '#0E1117',
    'axes.grid': True,
    ...
    # How streamlit is used to display the analysis
    st.markdown('##')
    st.text("How streamlit is used to display the analysis:")
    st.code('''#Streamlit App setup
st.title('Ethereum Account Analysis')
st.markdown('###### App to analyse the balance and transactions of any ethereum address')
